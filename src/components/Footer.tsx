...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/5 text-white/80 py-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#Services" className="hover:text-primary transition-colors">Capabilities</a></li>
              <li><a href="#ProcessTimeline" className="hover:text-primary transition-colors">Our Process</a></li>
              <li><a href="#Showcase" className="hover:text-primary transition-colors">Outcomes</a></li>
              <li><a href="#UnderstandingNetwork" className="hover:text-primary transition-colors">Ecosystem</a></li>
            </ul>
          </div>
